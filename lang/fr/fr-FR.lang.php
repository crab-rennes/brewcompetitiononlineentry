...
$label_entry_drop_off = "Points de dépot pour les participants";
...
$alert_text_068 = "Les inscriptions pour les ".$j_s_text." sont ouvertes.";
$alert_text_069 = "Inscrivez vous ici"; // missing punctuation intentional
$alert_text_070 = "Les inscriptions pour les ".$j_s_text." sont bientôt terminées : ".$judge_closed.".";
...
if ($section == "default") {
	...
	$default_page_text_016 = "est fier d'avoir les";
...
$pay_text_003 = "La participation est de";
...
$pay_text_021 = "Pour etre sur que votre paiement Paypal soit marqué comme <strong>payé</strong> sur ce site, assurez vous de cliquer sur le lien <em>Retour au...</em> sur l'écran de confirmation PayPal&rsquo;s <strong>après</strong> avoir envoyé votre paiement. Aussi, assurez vous d'imprimer votre reçu de paiement et de l'attacher à l'une de vos bouteilles.";
...
$label_entry_shipping = "Envoi des bouteilles";
